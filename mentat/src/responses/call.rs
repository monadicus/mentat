...
pub struct CallResponse {
    ...
    /// `CallResponse`. Integrators may cache the `CallResponse` if this is set
    /// to true to avoid making unnecessary calls to the Rosetta
    /// implementation. For this reason, implementers should be very
    /// conservative about returning true here or they could cause issues
    /// for the caller.
    pub idempotent: bool,
}
