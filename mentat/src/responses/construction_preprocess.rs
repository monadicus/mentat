...
/// blockchains require the [`PublicKey`] of particular [`AccountIdentifiers`]
...
/// desired [`PublicKeys`]. If it is not necessary to retrieve any
/// [`PublicKeys`] for construction, `required_public_keys` should be omitted.
