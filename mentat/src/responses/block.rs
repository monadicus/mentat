...
/// object. It is VERY important to note that blocks MUST still form a
/// canonical, connected chain of blocks where each block has a unique index. In
/// other words, the [`PartialBlockIdentifier`] of a block after an omitted
