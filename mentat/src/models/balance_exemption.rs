...
/// rewards, vesting balances, and Currencies with a dynamic supply. Currently,
/// it is possible to exempt an account from strict reconciliation by
/// SubAccountIdentifier.Address or by Currency. This means that any account
/// with SubAccountIdentifier.Address would be exempt or any balance of a
/// particular Currency would be exempt, respectively. BalanceExemptions should
/// be used sparingly as they may introduce significant complexity for
/// integrators that attempt to reconcile all account balance changes. If your
...
pub struct BalanceExemption {
    ...
    /// increase above or equal the computed balance. This typically occurs with
    /// staking rewards that accrue on each block. * less_or_equal: The live
    /// balance may decrease below or equal the computed balance. This typically
